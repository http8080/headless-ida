...
def _build_parser():
    ...
    stru_list.add_argument("--count", type=int, default=None, help="Max results")
    stru_list.add_argument("--offset", type=int, default=0, help="Start offset")
    ...
    enu_list.add_argument("--count", type=int, default=None, help="Max results")
    enu_list.add_argument("--offset", type=int, default=0, help="Start offset")
